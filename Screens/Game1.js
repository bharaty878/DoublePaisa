...
//             });
//         }else{
//               Alert.alert("Click on Ready & then Press Bell ")
//         }
...
//             </Modal>
//             <Text style={styles.txt1}>Double Paisa</Text>
//             <Text style={{color:"silver"}}>Note:-Press Bell Your Score Will Increase & You Will Be Winner </Text>
//             <View style={styles.View2}>
//                 <Text style={styles.Viewtxt2}>Score : {score}</Text>
//                 <Text style={styles.Viewtxt2}>Time Left : {time}</Text>
//             </View>
//             <TouchableOpacity style={styles.Btn1} onPress={Pla}>
//                 <Image source={require("../images/bell2.png")} style={styles.img1} />
//             </TouchableOpacity>
//             <TouchableOpacity style={styles.Btn2} onPress={()=>Ready()}>
//                       <Text style={styles.Btntxt2}>Ready</Text>
//             </TouchableOpacity>
